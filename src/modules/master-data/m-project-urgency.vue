...
<script>
export default {
  name: 'crud-m-project-urgency',
  data () {
    return {
      config: {
        title: 'Urgensi Proyek',
        model_api: 'm-project-urgency',
        getter: 'm-project-urgency',
        setter: 'm-project-urgency',
        pk_field: null,
        export: true,
        permission: {
          create: 'create-m-project-urgency',
          read: 'view-m-project-urgency',
          update: 'update-m-project-urgency',
          delete: 'delete-m-project-urgency'
        },
        fields: [
          { id: 'name', label: 'Nama', methods: { list: true, detail: true, create: true, update: true, filter: false } },
