const module = {
  ...
  routes: [
    ...
    // ==============
    { separator: 'Master Isu & Mitigasi', label: 'Kategori & Risk Register', name: 'm-issue-categories', icon: 'ri-stack-line', path: '/m-issue-categories', component: () => import('./../master-data/m-issue-categories.vue') },
